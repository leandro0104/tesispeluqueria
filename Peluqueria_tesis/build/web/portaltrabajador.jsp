<%-- 
    Document   : portaltrabajador
    Created on : 08-04-2018, 15:57:41
    Author     : Cote
--%>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="portaltraabajador.jsp" class="navbar-brand">
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            <li class="active"> <a href="portaltrabajador.jsp"><i class="icon-home"></i>Portal</a></li>
            <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Citas</a>
              <ul id="dashvariants" class="collapse list-unstyled">
                  <li><a href="agendar_citas.jsp" target="ventana">Agendar Cita</a></li>
        ...
        <div class="embed-responsive embed-responsive-4by3">
            <iframe src="inicio_trabajador.jsp" class="embed-responsive-item" name="ventana" ></iframe>
        </div>
        <br>
          <!-- Page Footer-->
